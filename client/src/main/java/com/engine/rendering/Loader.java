...
import com.engine.textures.TextureData;
...
public class Loader {
    ...
    public int loadTexture(String fileName) {
        ...
        try {
            texture = TextureLoader.getTexture("PNG", new FileInputStream(Config.RESOURCE_PATH + fileName
                    + ".png"));
            GL30.glGenerateMipmap(GL11.GL_TEXTURE_2D);
            GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER,
                    GL11.GL_LINEAR_MIPMAP_LINEAR);
            GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL14.GL_TEXTURE_LOD_BIAS, 0f);
            if(Config.ENABLE_ANISOTROPY && GLContext.getCapabilities().GL_EXT_texture_filter_anisotropic){
    ...
    public int loadCubeMap(String[] textureFiles) {
        ...
        for (int i = 0; i < textureFiles.length; i++) {
            TextureData data = decodeTextureFile(Config.RESOURCE_PATH + textureFiles[i] + ".png");
