package com.server.game.normalMappingRenderer;
...
public class NormalMappingShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = Config.GAME_PATH+"normalMappingRenderer/normalMapVShader.txt";
    private static final String FRAGMENT_FILE = Config.GAME_PATH+"normalMappingRenderer/normalMapFShader.txt";
